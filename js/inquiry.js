...
document.writeln("<form class=\"form-horizontal\" method=\"post\" name=\"form\" action=\"http://inquiry.zenithcrusher.com/updata.php\" onsubmit=\"return(CheckfootInput())\">");
 document.writeln("<h3 class=\"products-title\">Inquiry</h3>");
 document.writeln("<div class=\"products-introduce\">");
 ...
 document.writeln("<option selected=\"selected\" value=\"\" style=\" font-weight:bold;\">Please Select!</option>");
 ...
 document.writeln("</tr>");
 document.writeln("<tr>");
 document.writeln("<td><label class=\"control-label\">Materials:</label></td>");
 document.writeln("<td><!-- Multiple Checkboxes -->");
 document.writeln("<label class=\"checkbox\">");
 ...
 document.writeln("<br />");
 document.writeln("<label class=\"checkbox\"> Other:");
 document.writeln("<input name=\"title\" type=\"text\" value=\"As: Marble\" style=\" width:70%;color: rgb(153, 153, 153);\" onblur=\"if(value==\'\'){value=\'As: Marble\';this.style.color=\'#999\';};\" onfocus=\"if(value==\'As: Marble\'){value=\'\';this.style.color=\'#000\';};\" size=\"15\" />");
 document.writeln("</label></td>");
 document.writeln("</tr>");
 document.writeln("<tr>");
 document.writeln("<td><label class=\"control-label\">Capacity:</label></td>");
 document.writeln("<td><!-- Multiple Radios -->");
 document.writeln("<label class=\"radio\">");
 ...
 document.writeln("<tr>");
 document.writeln("<td><!-- Text input-->");
 document.writeln("<label class=\"control-label\" for=\"name\">Name:<span class=\"star\">*</span></label></td>");
 ...
 document.writeln("<tr>");
 document.writeln("<td><!-- Text input-->");
 document.writeln("<label class=\"control-label\" for=\"input01\">Email:<span class=\"star\">*</span></label></td>");
 ...
 document.writeln("<label class=\"control-label\">Message:<span class=\"star\">*</span></label></td>");
 ...
 document.writeln("<td><input type=\"submit\" value=\"Send Message\" class=\"btn btn-primary\" /></td>");
 document.writeln("</tr>");
